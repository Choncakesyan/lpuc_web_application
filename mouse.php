    ...
    <div style="float:left">
        <div class="pic_group">
            <div class="pic_option">
                <h1 style="text-align:center; margin-top:10px; font-size:30px; font-family:Algerian; color:black">Mouse Collection</h1>
                ...
                <div class="row">
                    <script>
                        const items = [
                            { name: "Aerox 3 Ultra", price: 2480 },
                            { name: "Corsair Dark Core", price: 3900 },
                            { name: "Deathadder v3", price: 7750 },
                            { name: "Ball Mouse", price: 350 },
                            { name: "G102 Logitech", price: 2490 },
                            { name: "G203 Logitech", price: 2300 },
                            { name: "G304 Logitech", price: 1500 },
                            { name: "G502 Logitech", price: 2100 },
                            { name: "Inquisitor 2", price: 600 },
                            { name: "M90 Logitech", price: 200 },
                            { name: "M350 Logitech", price: 575 },
                            { name: "M612 Predator", price: 700 },
                            { name: "Razer 900", price: 900 },
                            { name: "RGB Mouse", price: 250 },
                            { name: "M609 Phaser", price: 950 },
                            { name: "Red Dragon", price: 1350 },
                            { name: "Red Mouse", price: 350 },
                            { name: "Steelseries", price: 4125 },
                            { name: "Viper Ultimate", price: 4500 },
                            { name: "Wireless Mouse", price: 200 },
                        ];
                        ...
                        for (let i = 0; i < items.length; i++) {
                            ...
                            document.write(`
                                <div class="col-md-3">
                                    <div>
                                        <img src="mouse_images/${i + 1}.jpg" data-toggle="tooltip" data-placement="center" title="mouse" width="170" height="180" alt="${item.name}">
                                        <div>
